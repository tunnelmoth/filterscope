(function(){
  ...
  // language: ?lang=tr or #tr in the URL wins, then the saved choice; default is English
  var q=(location.search.match(/[?&]lang=(en|tr)/)||[])[1]||(location.hash==='#tr'?'tr':location.hash==='#en'?'en':null);
  if(q)setLang(q);else{try{var s=localStorage.getItem('fs-lang');if(s)setLang(s);}catch(e){}}
