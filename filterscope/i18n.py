...
STRINGS = {
    ...
    "tr": {
        ...
        "chk.download": "servisin CDN'inden indirme", "chk.baseline": "taban (Cloudflare)", "chk.udp_note": "UDP oyun ve ses portları oyun olmadan doğrulanamaz. Bunun yerine genel UDP çıkışı gösteriliyor.",
