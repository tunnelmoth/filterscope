...
STRINGS = {
    "en": {
        ...
        "chk.unknown": "Unknown service '{q}'. Known: {known}", "chk.ok": "{name}: works on this network (all endpoints, ports and CDN speed normal).",
        ...
        "chk.download": "download from the service's CDN", "chk.baseline": "baseline (Cloudflare)", "chk.udp_note": "UDP game/voice ports cannot be verified without the game; generic UDP egress shown.",
    ...
    "tr": {
        ...
        "chk.reasons": "neden", "chk.endpoints": "uç noktalar", "chk.ports": "TCP portları (çıkış)", "chk.udp": "UDP çıkışı",
        "chk.download": "servisin CDN'inden indirme", "chk.baseline": "taban (Cloudflare)", "chk.udp_note": "UDP oyun/ses portları oyun olmadan doğrulanamaz; genel UDP çıkışı gösteriliyor.",
